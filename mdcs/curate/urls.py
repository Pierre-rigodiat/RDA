...
urlpatterns = patterns('',
    ...
    url(r'^update_form_list$', 'curate.ajax.update_form_list'),
    ...
    url(r'^load_form_for_entry', 'curate.ajax.load_form_for_entry'),
    url(r'^save_html_form', 'curate.ajax.save_html_form'),
    url(r'^view_data', 'curate.ajax.view_data'),
    url(r'^validate_xml_data', 'curate.ajax.validate_xml_data'),
    url(r'^get_hdf5_string', 'curate.ajax.get_hdf5_string'),
