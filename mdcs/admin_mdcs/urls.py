...
urlpatterns = patterns('',
    ...
    url(r'^backup-database$', 'admin_mdcs.views.backup_database', name='backup_database'),
    url(r'^restore-database$', 'admin_mdcs.views.restore_database', name='restore_database'),
    ...
    url(r'^create_backup', 'admin_mdcs.ajax.create_backup'),
    url(r'^restore_backup', 'admin_mdcs.ajax.restore_backup'),
    url(r'^delete_backup', 'admin_mdcs.ajax.delete_backup'),
