...
@cd /d "%~dp0"
start cmd /k ..\mongodb\bin\mongod.exe --dbpath ..\data\db --bind_ip 127.0.0.1
...
start cmd /k ..\WinPython-32bit-2.7.6.3\python-2.7.6\python.exe ..\manage.py runserver --insecure
