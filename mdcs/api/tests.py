...
#         tV = TemplateVersion(nbVersions=0, isDeleted=False).save()
#         template = Template(title = "title", filename = "filename", content = "content", templateVersion=str(tV.id), version=1).save()
#         tV.nbVersions = 1        
#         tV.versions.append(str(template.id))
#         tV.current = str(template.id)
#         tV.save()
#         id = template.id
#         
...
#         TemplateVersion(id=str(tV.id)).delete()
#         
