	...
	*/	
	public static function transformXmlStringToJson($xmlStringContents) {
		...
		*/
		...
		$array1 = xml2jsonIBM::convertSimpleXmlElementObjectIntoArray($simpleXmlElementObject);
		...
		if ((is_object($simpleXmlElementObject)) ? (get_class($simpleXmlElementObject) == SIMPLE_XML_ELEMENT_PHP_CLASS) : false) {
   		...
   		if (is_array($simpleXmlElementObject)) {
       		...
       		foreach($simpleXmlElementObject as $key=>$value) {
				...
				$recursionDepth++;	       			
           		$resultArray[$key] = xml2jsonIBM::convertSimpleXmlElementObjectIntoArray($value, $recursionDepth);
