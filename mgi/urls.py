...
urlpatterns = patterns('',
    ...
    url(r'^my-profile/my-dashboard/resources$', 'mgi.views.my_profile_dashboard_resources', name='my-profile'),
    url(r'^my-profile/my-dashboard/templates$', 'mgi.views.my_profile_dashboard_templates', name='my-profile'),
    url(r'^my-profile/my-dashboard/types$', 'mgi.views.my_profile_dashboard_types', name='my-profile'),
    url(r'^my-profile/my-dashboard/files$', 'mgi.views.my_profile_dashboard_files', name='my-profile'),
    url(r'^my-profile/my-dashboard/toXML$', 'mgi.views.my_profile_dashboard_toXML', name='my-profile'),
    url(r'^my-profile/my-dashboard/edit_information$', 'mgi.views.edit_information', name='my-profile'),
    url(r'^my-profile/my-dashboard/delete_object$', 'mgi.views.delete_object', name='my-profile'),
    url(r'^my-profile/my-dashboard/modules$', 'mgi.views.my_profile_dashboard_modules', name='my-profile'),
