...
urlpatterns = patterns('',
    ...
    url(r'^dashboard/detail$', 'mgi.views.dashboard_detail_resource'),
    url(r'^dashboard/my-profile$', 'mgi.views.my_profile', name='my-profile'),
    url(r'^dashboard/resources$', 'mgi.views.dashboard_resources', name='dashboard-resources'),
    url(r'^dashboard/my-profile/favorites$', 'mgi.views.my_profile_favorites', name='my-profile-favorites'),
    url(r'^dashboard/my-profile/edit', 'mgi.views.my_profile_edit', name='my-profile-edit'),
    url(r'^dashboard/my-profile/change-password', 'mgi.views.my_profile_change_password', name='my-profile-change-password'),
    url(r'^dashboard/forms', 'mgi.views.dashboard_my_forms', name='dashboard-my-forms'),
