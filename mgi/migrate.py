...
MONGO_DB = 'mgi'
MONGODB_URI = "mongodb://" + MONGO_MGI_USER + ":" + MONGO_MGI_PASSWORD + "@localhost/" + MONGO_DB

# data_db_path = "C:\\Users\\GAS2\\workspace_prod\\MGI_Project\\mdcs\\data\\db"
backups_dir = "C:\\Users\\GAS2\\workspace_prod\\MGI_Project\\mdcs\\data\\backups"
...
#     _error('The data directory does not exist')
