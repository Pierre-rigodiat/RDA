...
urlpatterns = patterns('',
    ...
    url(r'^oai-pmh$', 'admin_mdcs.views.oai_pmh', name='oai_pmh'),
    url(r'^oai-pmh-build-request$', 'admin_mdcs.views.oai_pmh_build_request', name='oai_pmh_build_request'),
    url(r'^oai-pmh-detail-registry$', 'admin_mdcs.views.oai_pmh_detail_registry', name='oai_pmh_detail_registry'),
