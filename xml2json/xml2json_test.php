...
// Filename to where JSON contents are to be written.
$jsonFile = "";

// Read the filename from the command line.
if ($argc <= 1) {
	print("Please provide the XML filename as the first command-line argument:\n");
	return;
}
if ($argc <= 2) {
	print("Please provide the JSON filename as the second command-line argument:\n");
	return;
} else {
	$testXmlFile = $argv[1];
	$jsonFile = $argv[2];
